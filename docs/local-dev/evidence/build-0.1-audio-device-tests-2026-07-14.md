...
Completed on 2026-07-15. Exact staged AAC remained non-zero after boot, recovery reported `recovered=1`, final file existed under `Media/Audio`, and `Temp` was empty.
...
- Final AAC size: `3,847,100` bytes under removable `Media/Audio`.
